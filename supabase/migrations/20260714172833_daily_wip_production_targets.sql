-- Make Daily WIP labor math reflect the crew that was actually in the field,
-- and let the PM set a production-rate target for management comparison.
-- Existing records retain the historical two-person assumption.
