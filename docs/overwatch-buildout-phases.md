...
- Basic billing application ledger plus invoice PDF, email handoff, and payment-ledger foundation.
...
2. Replace the current invoice email handoff with a transactional client-send flow when the email service is selected.
